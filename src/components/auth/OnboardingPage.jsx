      ...
      <div class="onboard-card">
        ...
        {step === "choose" && (
          <div class="onboard-choices">
            <button
              class="onboard-choice"
              onClick={() => setStep("create-org")}
            >
              <span class="onboard-choice-icon onboard-choice-icon--brand">
                <BuildingIcon />
              </span>
              <div class="onboard-choice-text">
                <strong>Создать организацию</strong>
                <span>
                  Вы — руководитель агентства. Пригласите агентов после
                  регистрации.
                </span>
              </div>
            ...
            <button class="onboard-choice" onClick={() => setStep("join")}>
              <span class="onboard-choice-icon onboard-choice-icon--accent">
                <KeyIcon />
              </span>
              <div class="onboard-choice-text">
        ...
        <button class="onboard-signout" onClick={signOut}>
          Выйти из аккаунта
        </button>
      </div>
    </div>
